...
PROJECT_NAME ?= provider-solacebroker
PROJECT_REPO ?= github.com/bczoma/$(PROJECT_NAME)
...
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-solacebroker_v1.0.1
...
xpkg.build.provider-solacebroker: do.build.images
